...
func (a *Adapter) ClearEmployees(ctx context.Context) error {
	return fmt.Errorf("sunbeam: ClearEmployees not supported by this device")
}

func (a *Adapter) DeleteEmployee(ctx context.Context, employeeCode string) error {
	return fmt.Errorf("sunbeam: deleting one employee through the SDK is not supported by this device")
}

func (a *Adapter) DeleteFingerprint(ctx context.Context, employeeCode string, fingerIndex int) error {
	return fmt.Errorf("sunbeam: deleting fingerprints through the SDK is not supported by this device")
}
