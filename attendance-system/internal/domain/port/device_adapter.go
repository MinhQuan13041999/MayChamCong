...
type DeviceStatus struct {
	...
	ProtocolInfo    []string `json:"protocol_info,omitempty"`
	ProtocolActions []string `json:"protocol_actions,omitempty"`
...
type DeviceAdapter interface {
	...
	DeleteEmployee(ctx context.Context, employeeCode string) error
	...
	DeleteFingerprint(ctx context.Context, employeeCode string, fingerIndex int) error
	...
	ClearEmployees(ctx context.Context) error      // optional, tuỳ hãng hỗ trợ
