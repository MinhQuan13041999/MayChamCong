...
func NewRouter(
	...
	r.NotFound(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.HasPrefix(r.URL.Path, "/assets/") || strings.HasPrefix(r.URL.Path, "/css/") || strings.HasPrefix(r.URL.Path, "/js/") || strings.HasPrefix(r.URL.Path, "/models/") || strings.HasPrefix(r.URL.Path, "/styles.css") || strings.HasPrefix(r.URL.Path, "/app.js") {
