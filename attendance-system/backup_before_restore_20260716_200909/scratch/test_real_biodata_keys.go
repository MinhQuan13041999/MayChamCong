...
func main() {
	...
	formats := []string{
		// 1. BIODATA Pin= (CamelCase), Tmp= (CamelCase)
		fmt.Sprintf("DATA UPDATE BIODATA Pin=1015\tNo=6\tIndex=0\tValid=1\tDuress=0\tType=9\tMajorVer=5\tMinorVer=8\tFormat=0\tTmp=%s", realTemplate),
		// 2. BIODATA PIN= (All Caps), Tmp= (CamelCase)
		fmt.Sprintf("DATA UPDATE BIODATA PIN=1015\tNo=6\tIndex=0\tValid=1\tDuress=0\tType=9\tMajorVer=5\tMinorVer=8\tFormat=0\tTmp=%s", realTemplate),
		// 3. BIODATA PIN= (All Caps), TMP= (All Caps)
		fmt.Sprintf("DATA UPDATE BIODATA PIN=1015\tNo=6\tIndex=0\tValid=1\tDuress=0\tType=9\tMajorVer=5\tMinorVer=8\tFormat=0\tTMP=%s", realTemplate),
		// 4. BIODATA Pin= (CamelCase), TMP= (All Caps)
		fmt.Sprintf("DATA UPDATE BIODATA Pin=1015\tNo=6\tIndex=0\tValid=1\tDuress=0\tType=9\tMajorVer=5\tMinorVer=8\tFormat=0\tTMP=%s", realTemplate),
	}
